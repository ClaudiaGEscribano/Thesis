...
On the other hand, flexibility of the supply side depends on the power plants, whose output can be controled to be adapted in order to obtain power balance. It is important in terms of flexibility to consider the response time of different power plants as well as the different nature of each one. As the availability of solar and wind resources are not related to demand geographic distribution, highly interconected grid is one of the main needs for high VRE penetration. Once that is considered, geographycally spread portfolio of VRE plants are able to smooth variability of power output \cite*{KROPOSKI2017}.
...
There are different types of forecasting methods for solar power: physical methods, statistical methods and hybrid methods.
