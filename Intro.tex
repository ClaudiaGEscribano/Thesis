...
``Impact of atmospheric aerosols on the photovoltaic energy production scenario for the sahel zone''
...
Así como en el caso de las actividades de operación la variabilidad es un campo de estudio muy activo y la literatura es amplia, el estudio de la variabilidad tanto del recurso solar, como de las proyecciones de energía en escalas más largas es aún limitado. Debido a esto, algunos proyectos pueden verse afectados con impactos en su financiación o rentabilidad por una mala caracterización de la variabilidad interanual de la producción [] o debido al uso de bases de datos poco representativas para estimar la energía producida.
