...
\usepackage[b5paper]{geometry}%[b5paper]{geometry}%[a4paper]{geometry}
...
Facultad de Ciencias Ambientales y Bioquímica\\[0.5\baselineskip]
...
%\vfill
{\large Memoria para optar al grado de Doctor}\\[0.25\baselineskip]
%{\large Facultad de Ciencias Ambientales y Bioquímica}\\[0.25\baselineskip]
{\large Departamento de Ciencias Ambientales}\\[0.25\baselineskip]
{\large Instituto de Ciencias Ambientales (ICAM)}\\[0.25\baselineskip]
{\large Toledo, 2019}
\end{center}
\flushleft
