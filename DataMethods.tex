...
\nomenclature[BSRN]{$BSRN$}{Baselina Surface Radiation Network}
...
\nomenclature[G(alfa,beta)]{$G(\alpha, \beta)$}{Global irradiation at the plane of the array. Alpha and beta correspond to the inclination and ** angles of the panel.}
