...
\midrule 
%\mr  
  CNRM-CERFACS-CNRM-CM5& & 9.8 & 0.7 & & -0.4 &  \\
            &ALADIN53 & 13.2 & 0.3 & -0.2 & -0.2 & -0.9\\
            &CCLM4-8-17& -2.8 & -0.8 & - & -0.7 & -  \\
            &RCA4& -2.8 & 0.2 & - & -0.8 & - \\
\midrule
%\mr   
  ICHEC-EC-EARTH& &5.6 & -0.3 & &-0.3 &  \\
          &RACMO& 4.8 & 0.5 & -0.1 & -0.3 & -0.6 \\
          &CCLM4-8-17& -3.0 & -0.8 & - & -0.8 & - \\
          &RCA4&-2.3 & 0.1 & - & -0.8 & - \\
\bottomrule
%\br
\end{tabular}\\
...
\midrule 
%\mr   
  \\CNRM-CM5&ALADIN53& 5.9$\%$ & 4.8 $\%$ & 2.4$\%$ & 10.9$\%$ & 6.4$\%$ & 4.6$\%$ & 11.2$\%$ & 12.2$\%$ \\
