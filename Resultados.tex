...
\begin{table}[h!]
\caption[SSR, CLT anomalies and spatial correlation for Med-CORDEX models]{\label{tb:medcordexspcor}SSR (W/m²), CLT (\%) anomalies and spatial correlation between them.}
%\footnotesize
